		...
		<PageLayout seo={seoParams}>
			<LoginContainer>
				<section ref={animationHeader}>
					...
					<StaticImage className='shadow' src={headerImg} alt='Image de la page de connexion' />
				</section>
				<section ref={animationParent}>
					<StaticImage src={logo} alt='Logo Jour de Fete' layout='fixed' width={380} />
					<h1>Le planning</h1>
					...
					<InternetChecker>
						<form onSubmit={handleSubmit}>
							...
							/>
							<button
								className={`big purple ${serverState.submitting ? 'disabled' : ''}`}
								type='submit'>
